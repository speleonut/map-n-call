...
# Requires: GATKv4.x
#
# Usage: sbatch $0 -i /path/to/sequence_files.txt [ -o /path/to/output -c /path/to/config.cfg ] | [ - h | --help ]
#
# Options
...
cd $tmpDir
${GATKPATH}/gatk --java-options "-Xmx8g -Djava.io.tmpdir=${tmpDir}" VariantFiltration  \
