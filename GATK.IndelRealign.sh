...
#SBATCH -J IndelRA
#SBATCH -o /fast/users/%u/log/indelRA-%j.out
...
-rf BadCigar \
-o ${bedFile[$SLURM_ARRAY_TASK_ID]}.$sample.realigned.bwa.$BUILD.bam >> $tmpDir/${bedFile[$SLURM_ARRAY_TASK_ID]}.$sample.pipeline.log 2>&1
